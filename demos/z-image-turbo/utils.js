...
// get prompt inputs data for text encoder
async function getPromptInputs(prompt, maxSequenceLength) {
...
export { getPromptInputs, drawImage, getConfig, getModelOPFS, getMode, sizeOfShape, createLatents, appendFloat32 };
